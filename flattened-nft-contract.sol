...
// File @openzeppelin/contracts/utils/Base64.sol@v5.2.0
...
contract MyNFT is ERC721, Ownable {
    ...
    function mint(
        ...
        _descriptions[newTokenId] = description;
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '"type": "object",',
                        '"properties": {',
                        '"name": {"type": "string", "value": "', _names[tokenId], '"},',
                        '"description": {"type": "string", "value": "', _descriptions[tokenId], '"},',
                        '"image": {"type": "string", "value": "', _imageURIs[tokenId], '"}',
                        '}}'
                    )
                )
            )
